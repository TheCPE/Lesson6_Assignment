...
function previewFive() {
  ...
  // add apprpriate src values to two new img elements
...
// create event listeners for left arrow, right arrow, and center figure element function
...
function zoomFig() {
   var zoomWindow = window.open('zoom.htm', 'zoowin', 'with=960, height=600');
}
